namespace MyTend.Services.Migrations
{
    ...
    public class TenderThemesMigration2 : IMigration
    {
        ...
        public void Migrate()
        {
            ...
            list.Add(new TenderTheme() { ImageName = "3.svg", IsTitle = false, NomberInList = 3, Theme = t3, Title = "Мне требуется аренда звуковой/световой аппаратуры", });
            ...
            list.Add(new TenderTheme() { ImageName = "5.svg", IsTitle = false, NomberInList = 8, Theme = t5, Title = "Мне требуется пианист" });
            ...
            list.Add(new TenderTheme() { ImageName = "5.svg", IsTitle = false, NomberInList = 20, Theme = t5, Title = "Мне требуется ледовое шоу", });
            list.Add(new TenderTheme() { ImageName = "5.svg", IsTitle = false, NomberInList = 21, Theme = t5, Title = "Мне требуется Дед Мороз, Снегурочка на дом/в офис/на корпоратив", });
            list.Add(new TenderTheme() { ImageName = "5.svg", IsTitle = true, NomberInList = 22, Theme = t5, Title = "Танцоры:", });
            list.Add(new TenderTheme() { ImageName = "5.svg", IsTitle = false, NomberInList = 23, Theme = t5, Title = "Мне требуется шоу-балет", });
            list.Add(new TenderTheme() { ImageName = "5.svg", IsTitle = false, NomberInList = 24, Theme = t5, Title = "Мне требуется классический балет", });
            list.Add(new TenderTheme() { ImageName = "5.svg", IsTitle = false, NomberInList = 25, Theme = t5, Title = "Мне требуется артист(ка) стриптиза", });
            list.Add(new TenderTheme() { ImageName = "5.svg", IsTitle = false, NomberInList = 26, Theme = t5, Title = "Мне требуется танец живота", });
            list.Add(new TenderTheme() { ImageName = "5.svg", IsTitle = false, NomberInList = 27, Theme = t5, Title = "Мне требуется танец со змеями", });
            ...
            list.Add(new TenderTheme() { ImageName = "6.svg", IsTitle = true, NomberInList = 4, Theme = t6, Title = "Кейтеринг/Выездное питание/обслуживание гостей:", });
            ...
            list.Add(new TenderTheme() { ImageName = "7.svg", IsTitle = false, NomberInList = 1, Theme = t7, Title = "Мне требуется пошив платья для невесты/подружек невесты", });
            ...
            list.Add(new TenderTheme() { ImageName = "10.svg", IsTitle = false, NomberInList = 2, Theme = t10, Title = "Мне требуется коттедж с баней/бассейном", });
